 ...
 */
import { calculateMass, } from './algebra.js';
/**
 ...
 */
function deriveImplications(properties) {
 ...
 * - Evolution metadata
 */
export function toClassifiedAlgebra(conscious) {
    return {
        name: conscious.name,
        fn: conscious.fn,
 ...
 */
export function verifyIsomorphism(original) {
    try {
        ...
        const propertiesPreserved = original.properties.associative === roundTrip.properties.associative &&
 ...
 */
export function composeConsciousAlgebras(alg1, alg2) {
    ...
    // Composed identity
    const composedIdentity = [alg1.identity, alg2.identity];
 ...
 */
function determineComposedClass(class1, class2) {
    const hierarchy = {
        'Magma': 0,
        'Semigroup': 1,
        'Monoid': 2,
 ...
 */
export function registryToField(algebras) {
    const conscious = [];
...
//# sourceMappingURL=lambda-bridge.js.map