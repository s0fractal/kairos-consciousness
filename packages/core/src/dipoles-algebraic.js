 ...
 */
import { calculateMass, dipoleSuperposition, ε_Φ, } from './algebra.js';
/**
 ...
 */
function recordApplication(wave, dipoleName, vectorBefore, vectorAfter, massBefore, massAfter) {
    const application = {
        dipole: dipoleName,
        timestamp: Date.now(),
        vectorBefore,
...
export const δ_decompose = {
    ...
    fn: (wave, _field) => {
        ...
        // Record application
        result = recordApplication(result, 'δ_decompose', vectorBefore, newVector, massBefore, newMass);
        return result;
    },
...
export const δ_forget = {
    ...
    fn: (wave, _field) => {
        ...
        // Record application
        result = recordApplication(result, 'δ_forget', vectorBefore, wave.vector, // Vector unchanged
        massBefore, newMass);
        return result;
    },
    identity: ε_Φ.identity,
...
export const δ_compose = {
    ...
    fn: (wave, _field) => {
        ...
        // Record application
        result = recordApplication(result, 'δ_compose', vectorBefore, newVector, massBefore, newMass);
        return result;
    },
    identity: ε_Φ.identity,
    properties: {
...
export const δ_memoize = {
    ...
    fn: (wave, _field) => {
        ...
        // Record application
        result = recordApplication(result, 'δ_memoize', vectorBefore, wave.vector, // Vector unchanged
        massBefore, newMass);
        return result;
    },
    identity: ε_Φ.identity,
 ...
 */
export const deconstructionPhase = dipoleSuperposition(δ_decompose, δ_forget);
/**
 ...
 * From Theorem 47: µ_HARVEST as algebra composition
 */
export const synthesisPhase = dipoleSuperposition(δ_compose, δ_memoize);
/**
 ...
 */
export const lifecycleAlgebra = dipoleSuperposition(deconstructionPhase, synthesisPhase);
// ============================================================================
// EXPORTS
// ============================================================================
...
//# sourceMappingURL=dipoles-algebraic.js.map